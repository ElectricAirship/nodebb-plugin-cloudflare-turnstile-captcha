...
const NodeBBVersion = require(require.main.require("./src/constants").paths
...
async function callAkismet(uri, data) {
  const headers = {
    ...
    "User-Agent": `NodeBB/${NodeBBVersion} | nodebb-plugin-cloudflare-turnstile-captcha/${SpamBeGoneVersion}`,
  };
