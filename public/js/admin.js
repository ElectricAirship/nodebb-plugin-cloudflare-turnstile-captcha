...
define("admin/plugins/cloudflare-turnstile-captcha", [
  "settings",
  "alerts",
  ...
  Admin.init = function () {
    ...
    wrapper
      .find('input[type="checkbox"][data-toggle-target]')
      .on("change", onChange);
    ...
    $("#save").on("click", function (e) {
      ...
      wrapper
        ...
        .each(function (i, checkbox) {
          ...
          if (
            checkbox.is(":checked") &&
            !wrapper.find(checkbox.attr("data-toggle-target")).val()
          ) {
            // eslint-disable-next-line no-plusplus
            invalidSelector +=
              (!invalidCount++ ? "" : ", ") +
              checkbox.attr("data-toggle-target");
          }
        });
      ...
      if (invalidSelector) {
        ...
        Settings.save(nbbId, wrapper, function () {
          alerts.alert({
            ...
            message:
              "Please reload your NodeBB to have your changes take effect",
            clickfn: function () {
